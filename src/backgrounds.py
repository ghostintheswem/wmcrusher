...
foregrounds = [f"decoration{i}.png" for i in range(376)]
papers = [f"paper{i}.png" for i in range(43)]
backgrounds = [f"background{i}.jpg" for i in range(26)]


# --- Execution ---
foreground_paths = foregrounds
background_paths = papers
